        ...
        <div className="card-glass relative overflow-hidden group hover:scale-105 cursor-pointer">
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted leading-relaxed">
              ...
              automate support, streamline ops, and turn data into decisions. I
              work directly with your team to deliver pragmatic, secure
              outcomes.
            </p>
          </div>
        </div>
      ...
      <div className="mb-20">
        <div className="container-wide text-center mb-12">
          ...
          <p className="text-xl text-muted max-w-2xl mx-auto">
            ...
            integrations for SMBs — assistants, automations, and analytics that
            pay for themselves.
          </p>
        </div>
        <div className="container-wide grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-muted leading-relaxed">
              For the past decade, I've helped teams adopt AI to reduce busywork
              and improve customer experience. My focus is practical delivery
              over hype — ship value in weeks, not months, with clear
              safeguards.
            </p>
            <p className="text-lg text-muted leading-relaxed">
        ...
        <div className="container-wide grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card-glass p-6 hover:scale-105 transition-all duration-300 group">
            ...
            <p className="text-muted mb-4">
              Prove value with a focused pilot in weeks, then scale
              deliberately.
            </p>
          ...
          <div className="card-glass p-6 hover:scale-105 transition-all duration-300 group">
            ...
            <p className="text-muted mb-4">
              Keep humans in control with approvals, audits, and clear
              escalation paths.
            </p>
            <div className="flex flex-wrap gap-2">
          ...
          <div className="card-glass p-6 hover:scale-105 transition-all duration-300 group">
            ...
            <p className="text-muted mb-4">
              Private deployments, data controls, and sensible defaults for
              safety.
            </p>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="container-wide grid sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="card-glass text-center group hover:scale-110 cursor-pointer">
            ...
            <p className="text-sm text-muted leading-relaxed">
              Define success upfront. Track deflection, hours saved, and revenue
              impact.
            </p>
          </div>
          <div className="card-glass text-center group hover:scale-110 cursor-pointer">
            ...
            <p className="text-sm text-muted leading-relaxed">
              Choose the right stack for your constraints. No lock‑in or hidden
              agendas.
            </p>
          </div>
          <div className="card-glass text-center group hover:scale-110 cursor-pointer">
            ...
            <p className="text-sm text-muted leading-relaxed">
              Frequent releases keep momentum and de‑risk change.
            </p>
          </div>
          <div className="card-glass text-center group hover:scale-110 cursor-pointer">
            <div className="text-4xl mb-4 group-hover:scale-125 transition-transform duration-300">
            ...
            <p className="text-sm text-muted leading-relaxed">
              Documentation and training so you can run it without me.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto p-12 rounded-4xl border border-glass-border bg-gradient-to-br from-glass via-glass-2 to-glass backdrop-blur-xl relative overflow-hidden group hover:scale-[1.02] transition-all duration-500">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-muted mb-8 max-w-2xl mx-auto">
              Book a 20‑minute intro. We'll identify a high‑impact assistant,
              automation, or analytics pilot we can ship in ~3 weeks.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="/services" className="btn-outline px-8 py-4">
                See services
              </a>
            </div>
