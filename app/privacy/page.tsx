      ...
      <section className="relative">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="text-muted-foreground mb-8">
            We take privacy seriously and design projects to respect your data
            and your customers. This page summarizes our general approach.
          ...
          <div className="space-y-8">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Least-privilege access with auditability and clear
                  off-boarding.
                </li>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We respect browser privacy signals (Do Not Track / Global
                Privacy Control) and collect analytics only when permitted. If
                consent is required, you can manage it via the consent banner.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Data is processed solely to deliver the agreed services. We do
                not sell data. Access is time-bound and scoped to your project.
              </p>
            </section>
          </div>
        </div>
