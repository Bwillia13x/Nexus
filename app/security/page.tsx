    ...
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <p className="text-muted-foreground mb-8">
          We design projects for safety and clarity. This page outlines general
          practices. Project-specific controls are detailed in your statement of
          work (SOW).
        </p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>Credential sharing via secure vaults or temporary tokens.</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">Hosting & Isolation</h2>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>Data processing only for agreed services, not for resale.</li>
            </ul>
