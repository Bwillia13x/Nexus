...
export const metadata = {
  ...
  description: 'Productized offerings for Calgary small and mid-sized businesses: AI Assistant Setup, Automation Audit + Pilot, and Analytics Quickstart.',
};
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="text-center mb-20">
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-xl text-muted leading-relaxed">
            Fast, practical AI integrations for Calgary teams: AI Assistant Setup, Automation Audit + Pilot, and Analytics Quickstart.
          </p>
        </div>
          ...
          {list.map((s, index) => (
            <div key={s.id} id={s.id} className="relative">
              ...
              <div className="p-8 md:p-12 rounded-4xl border border-glass-border bg-glass backdrop-blur-lg shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                {/* Benefits Section */}
                <div className="mb-12">
                  <h3 className="text-2xl font-semibold mb-6 text-ink">Key Benefits</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    {s.benefits.map((benefit, idx) => (
                      <div key={idx} className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-primary/5 to-secondary/5 border border-primary/10">
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-12">
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold mb-4 text-ink">What's Included</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold mb-4 text-ink">Deliverables</h3>
                    <ul className="space-y-3">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold mb-4 text-ink">Project Details</h3>
                    <div className="space-y-4">
                      ...
                      <div className="p-4 rounded-xl bg-gradient-to-r from-primary/5 to-secondary/5 border border-primary/10">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="font-semibold text-ink">Starting At</span>
                        </div>
                        <p className="text-2xl font-bold text-ink">{s.pricing}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <Link href="/contact" className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-primary to-secondary text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
