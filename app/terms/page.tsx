    ...
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <p className="text-muted-foreground mb-8">
          These terms outline the general conditions for using our services and
          website. For any project-specific terms, please refer to your
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              Services are provided as-is for the agreed scope. Changes to scope
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              We respect confidential information. Non-disclosure agreements can
              be executed on request.
            </p>
          </section>
